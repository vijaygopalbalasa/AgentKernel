...
If you discover a security vulnerability in AgentKernel, please report it responsibly.

**DO NOT** open a public GitHub issue for security vulnerabilities.

Instead, open a [private security advisory](https://github.com/vijaygopalbalasa/AgentKernel/security/advisories/new) on GitHub with:
...
AgentKernel runs AI agents that execute code, make API calls, and interact with external systems. The primary threats are:
